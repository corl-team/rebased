...
from src.mixers.mamba_ssm.triton.layernorm import (
    RMSNorm,
    layer_norm_fn,
    rms_norm_fn,
)
...
try:
    from src.mixers.mamba_ssm.selective_scan_interface import (
        selective_scan_fn,
        mamba_inner_fn,
    )
except:
...
class MambaBlock(nn.Module):
    def __init__(
        ...
        **factory_kwargs,
        ...
        from src.mixers.mamba_ssm.triton.layernorm import RMSNorm
